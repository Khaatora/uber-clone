...
class SignInWithFacebookUseCase extends IUseCase<MyUser, NoParams>{
  final IUserRepository userRepository;

  SignInWithFacebookUseCase(this.userRepository);
  @override
  Future<Either<Failure, MyUser>> call(NoParams params) {
    return userRepository.signInWithFacebook(params);
  }
